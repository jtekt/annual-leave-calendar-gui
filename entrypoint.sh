...
do
  ...
  sed -i 's|VITE_LEAVE_TYPES_FULL_DAY_PLACEHOLDER|'${VITE_LEAVE_TYPES_FULL_DAY}'|g' $file
  sed -i 's|VITE_LEAVE_TYPES_MORNING_PLACEHOLDER|'${VITE_LEAVE_TYPES_MORNING}'|g' $file
  sed -i 's|VITE_LEAVE_TYPES_AFTERNOON_PLACEHOLDER|'${VITE_LEAVE_TYPES_AFTERNOON}'|g' $file
  sed -i 's|VITE_LEAVE_TYPES_EXCLUDED_PLACEHOLDER|'${VITE_LEAVE_TYPES_EXCLUDED}'|g' $file
